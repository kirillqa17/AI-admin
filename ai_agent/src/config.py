...
class Settings(BaseSettings):
    ...
    crm_type: Optional[str] = Field(None, description="[DEV ONLY] Тип CRM: yclients, dikidi, bitrix24, 1c")
    crm_api_key: Optional[str] = Field(None, description="[DEV ONLY] CRM API Key")
    crm_base_url: Optional[str] = Field(None, description="[DEV ONLY] Base URL для CRM")
